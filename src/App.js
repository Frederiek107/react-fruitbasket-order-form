    ...
    return (
        <>
            ...
            < ArticleButton
                ...
                removeItem={() => {setCounterBanaan(counterBanaan - 1);
                if (counterBanaan===0) {
                setCounterBanaan(0)}}}
            />
            ...
            <ArticleButton
                ...
                removeItem={() => {setCounterAardbei(counterAardbei- 1);
                    if (counterAardbei===0) {
                        setCounterAardbei(0)}}}
            />
            ...
            <ArticleButton
                ...
                removeItem={() => {setCounterAppel(counterAppel- 1);
                    if (counterAppel===0) {
                        setCounterAppel(0)}}}
            />
            ...
            <ArticleButton
                ...
                removeItem={() => {setCounterKiwi(counterKiwi- 1);
                    if (counterKiwi===0) {
                        setCounterKiwi(0)}}}
            />
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <Label
                    ...
                    id="age"
                    condition={errors.age && <p>Dit veld is verplicht. Je moet minimaal 18 jaar oud zijn om te kunnen bestellen.</p>}/>
